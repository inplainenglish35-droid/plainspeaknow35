  ...
  <DialogPortal>
    ...
    <DialogPrimitive.Content
      ...
      className={cn(
        ...
        "rounded-xl bg-white dark:bg-gray-900 shadow-lg p-6",
    ...
    >
      {children}
      <DialogPrimitive.Close className="absolute right-4 top-4 rounded-md p-1 text-gray-500 hover:text-gray-700 dark:hover:text-gray-300 focus:outline-none">
        <X className="h-4 w-4" />
